...
layui.use('table', function(){
    ...
    table.render({
        ...
        ,page: false //开启分页
        ,cols: [[ //表头
            {field: 'agentId', title: 'ID',width:'10%' , sort: true,align:'center'}
            ,{field: 'sysTypeCode', title: '系统类别代码',width:'10%' ,align:'center'}
            ,{field: 'proxyName', title: '代理名称',width:'10%' ,align:'center'}
            ,{field: 'proxyIP', title: '代理IP',width:'10%' ,align:'center',hide:true}
            ,{field: 'proxyPort', title: '代理端口',width:'10%' ,align:'center',hide:true}
            ,{field: 'status', title: '状态',width:'10%' ,align:'center',hide:true}
            ,{field: 'operate', title: '操作',width:'10%',toolbar:'#barDemo',align:'center'}
        ]]
    });
    //监听工具条
    table.on('tool(agentEvent)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
