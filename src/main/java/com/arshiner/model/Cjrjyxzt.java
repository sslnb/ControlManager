...
public class Cjrjyxzt  implements Serializable{
    /**
	 * 
	 */
    ...
    public void setFwqljzt(String fwqljzt) {
        this.fwqljzt = fwqljzt == null ? null : fwqljzt.trim();
    }
    ...
    public void setFwqcwms(String fwqcwms) {
        this.fwqcwms = fwqcwms == null ? null : fwqcwms.trim();
    }
    ...
    public void setSjkljzt(String sjkljzt) {
        this.sjkljzt = sjkljzt == null ? null : sjkljzt.trim();
    }
    ...
    public void setSjkcwms(String sjkcwms) {
        this.sjkcwms = sjkcwms == null ? null : sjkcwms.trim();
    }
    ...
    public void setZlhqfs(String zlhqfs) {
        this.zlhqfs = zlhqfs == null ? null : zlhqfs.trim();
    }
    ...
    public void setKhdzt(String khdzt) {
        this.khdzt = khdzt == null ? null : khdzt.trim();
    }
    ...
    public void setKhdcwms(String khdcwms) {
        this.khdcwms = khdcwms == null ? null : khdcwms.trim();
    }
    ...
    public void setZxrzmlzt(String zxrzmlzt) {
        this.zxrzmlzt = zxrzmlzt == null ? null : zxrzmlzt.trim();
    }
    ...
    public void setZxrzcwms(String zxrzcwms) {
        this.zxrzcwms = zxrzcwms == null ? null : zxrzcwms.trim();
    }
    ...
    public void setGdrzmlzt(String gdrzmlzt) {
        this.gdrzmlzt = gdrzmlzt == null ? null : gdrzmlzt.trim();
    }
    ...
    public void setGdrzcwms(String gdrzcwms) {
        this.gdrzcwms = gdrzcwms == null ? null : gdrzcwms.trim();
    }
    ...
    public void setClyxzt(String clyxzt) {
        this.clyxzt = clyxzt == null ? null : clyxzt.trim();
    }
    ...
    public void setZlyxzt(String zlyxzt) {
        this.zlyxzt = zlyxzt == null ? null : zlyxzt.trim();
    }
