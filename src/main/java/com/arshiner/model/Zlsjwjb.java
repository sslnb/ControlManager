...
public class Zlsjwjb {
    ...
    private BigDecimal seqq;

    private BigDecimal scnz;

    private BigDecimal seqz;
    ...
    public BigDecimal getSeqq() {
        return seqq;
    }

    public void setSeqq(BigDecimal seqq) {
        this.seqq = seqq;
    }
    ...
    public BigDecimal getSeqz() {
        return seqz;
    }

    public void setSeqz(BigDecimal seqz) {
        this.seqz = seqz;
    }
