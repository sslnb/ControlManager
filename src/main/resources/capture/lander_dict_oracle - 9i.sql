...
select mem from (select  'logfile ' || member as mem from    v$logfile where   (upper(status) = 'STALE' or status is NULL) and group#=1 order by mem asc) where rownum=1
union
select mem from (select  'logfile ' || member as mem from    v$logfile where   (upper(status) = 'STALE' or status is NULL) and group#=2 order by mem asc) where rownum=1
union
select mem from (select  'logfile ' || member as mem from    v$logfile where   (upper(status) = 'STALE' or status is NULL) and group#=3 order by mem asc) where rownum=1
union
select mem from (select  'logfile ' || member as mem from    v$logfile where   (upper(status) = 'STALE' or status is NULL) and group#=4 order by mem asc) where rownum=1
union
select mem from (select  'logfile ' || member as mem from    v$logfile where   (upper(status) = 'STALE' or status is NULL) and group#=5 order by mem asc) where rownum=1
union
select mem from (select  'logfile ' || member as mem from    v$logfile where   (upper(status) = 'STALE' or status is NULL) and group#=6 order by mem asc) where rownum=1
union
select mem from (select  'logfile ' || member as mem from    v$logfile where   (upper(status) = 'STALE' or status is NULL) and group#=7 order by mem asc) where rownum=1
union
select mem from (select  'logfile ' || member as mem from    v$logfile where   (upper(status) = 'STALE' or status is NULL) and group#=8 order by mem asc) where rownum=1
union
select mem from (select  'logfile ' || member as mem from    v$logfile where   (upper(status) = 'STALE' or status is NULL) and group#=9 order by mem asc) where rownum=1
union
select mem from (select  'logfile ' || member as mem from    v$logfile where   (upper(status) = 'STALE' or status is NULL) and group#=10 order by mem asc) where rownum=1
union
select mem from (select  'logfile ' || member as mem from    v$logfile where   (upper(status) = 'STALE' or status is NULL) and group#=11 order by mem asc) where rownum=1
union
select mem from (select  'logfile ' || member as mem from    v$logfile where   (upper(status) = 'STALE' or status is NULL) and group#=12 order by mem asc) where rownum=1;
/*
